...
var blackBoxesFinal = blackBoxes.concat(blackBoxesSymmetric)
  ...
  for (var i=0; i<rows; i++){
    ...
    paper.innerHTML += `
    <img 
        src="${repo_site}img/whitebox.png" 
        style="position: absolute; top:${matrix[i][0]*(trial.size_cells-2)}px; 
        left:${matrix[i][1]*(trial.size_cells-2)}px; 
  ...
  paper.innerHTML += `
  <img 
    src="${repo_site}img/blackbox.png" 
    style="position: absolute; 
    top:${blackBoxesFinal[i][0]*(trial.size_cells-2)}px; 
    left:${blackBoxesFinal[i][1]*(trial.size_cells-2)}px; 
    width:${trial.size_cells}px; 
    height:${trial.size_cells}px;"
  >
  </img>
